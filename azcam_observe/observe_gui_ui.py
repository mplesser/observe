...
class Ui_observe(object):
    def setupUi(self, observe):
        ...
        self.tableWidget_script.setGeometry(QRect(10, 120, 911, 61))
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.tableWidget_script.sizePolicy().hasHeightForWidth()
        )
        ...
        self.pushButton_abort_script.setGeometry(QRect(650, 50, 81, 31))
        font1 = QFont()
        font1.setBold(False)
        font1.setWeight(50)
        self.pushButton_abort_script.setFont(font1)
        ...
        self.pushButton_selectscript.setGeometry(QRect(750, 10, 91, 31))
        self.label_status = QLabel(self.centralwidget)
        self.label_status.setObjectName(u"label_status")
        self.label_status.setGeometry(QRect(10, 90, 911, 20))
        ...
        self.pushButton_pause_script.setGeometry(QRect(550, 50, 91, 31))
        self.pushButton_pause_script.setFont(font1)
        ...
        self.pushButton_editscript.setGeometry(QRect(750, 50, 91, 31))
        ...
        self.doubleSpinBox_ExpTimeScale.setGeometry(QRect(350, 50, 62, 30))
        ...
        self.label_loops_2.setGeometry(QRect(300, 50, 41, 30))
        self.pushButton_scale_et = QPushButton(self.centralwidget)
        self.pushButton_scale_et.setObjectName(u"pushButton_scale_et")
        self.pushButton_scale_et.setGeometry(QRect(420, 50, 61, 31))
        self.pushButton_scale_et.setFont(font1)
    ...
    def retranslateUi(self, observe):
        ...
        self.actionSelect_Script.setText(
            QCoreApplication.translate("observe", u"Select Script", None)
        )
        ...
        # if QT_CONFIG(tooltip)
        self.tableWidget_script.setToolTip(
            QCoreApplication.translate("observe", u"script command table", None)
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.pushButton_run.setToolTip(
            QCoreApplication.translate("observe", u"execute the script", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.pushButton_abort_script.setToolTip(
            QCoreApplication.translate(
                "observe",
                u"<html><head/><body><p>abort script execution as soon as possible</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.pushButton_abort_script.setText(
            QCoreApplication.translate("observe", u"Abort Script", None)
        )
        # if QT_CONFIG(tooltip)
        self.spinBox_loops.setToolTip(
            QCoreApplication.translate(
                "observe",
                u"<html><head/><body><p>Number of times to run the complete script</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.plainTextEdit_filename.setPlainText(
            QCoreApplication.translate(
                "observe", u"C:/azcam/systems/90prime6/ObservingScripts/test.txt", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.pushButton_selectscript.setToolTip(
            QCoreApplication.translate("observe", u"select a script on disk", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.pushButton_selectscript.setText(
            QCoreApplication.translate("observe", u"Select Script", None)
        )
        ...
        self.pushButton_loadscript.setToolTip(
            QCoreApplication.translate(
                "observe", u"load the script into the table below", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.pushButton_loadscript.setText(
            QCoreApplication.translate("observe", u"Load Script", None)
        )
        # if QT_CONFIG(tooltip)
        self.label_counter.setToolTip(
            QCoreApplication.translate("observe", u"watchdog", None)
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.pushButton_pause_script.setToolTip(
            QCoreApplication.translate(
                "observe",
                u"<html><head/><body><p>Pause/Resume a running script (toggle)</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.pushButton_pause_script.setText(
            QCoreApplication.translate("observe", u"Pause/Resume", None)
        )
        # if QT_CONFIG(tooltip)
        self.pushButton_editscript.setToolTip(
            QCoreApplication.translate("observe", u"edit the script file", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.pushButton_editscript.setText(
            QCoreApplication.translate("observe", u"Edit Script", None)
        )
        # if QT_CONFIG(tooltip)
        self.doubleSpinBox_ExpTimeScale.setToolTip(
            QCoreApplication.translate(
                "observe", u"scale to apply to all exposure times", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_loops_2.setText(
            QCoreApplication.translate("observe", u"ET Scale", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.pushButton_scale_et.setStatusTip(
            QCoreApplication.translate(
                "observe", u"apply ET Scale to exposure time", None
            )
        )
        # endif // QT_CONFIG(statustip)
        self.pushButton_scale_et.setText(
            QCoreApplication.translate("observe", u"Scale ET", None)
        )
